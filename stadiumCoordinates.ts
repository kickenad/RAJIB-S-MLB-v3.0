...
export const stadiumCoordinates: { [key: string]: { lat: number; lon: number } } = {
    ...
    "Nationals Park": { lat: 38.8729, lon: -77.0075 },
    "Citizens Bank Park": { lat: 39.9061, lon: -75.1665 },
    "PNC Park": { lat: 40.4469, lon: -80.0057 },
    "Great American Ball Park": { lat: 39.0975, lon: -84.5069 },
